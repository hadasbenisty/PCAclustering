function [tree, embedding] = BuildTreeViaPCAclustering(data, params)

% not using the embedding of SVNClass - embed here
[vecs, vals] = CalcEigs(threshold(data, params.threshold), params.eigs_num);
embedding = vecs*vals;
if params.runOnEmbdding
    data = embedding;
end
...
% not using the embedding of SVNClass - embed here
clustering = svdClass({permute(data, [2 3 1])}, params.k, false, 0, ...
